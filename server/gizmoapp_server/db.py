...
def initialize_database(config: dict) -> None:
    ...
    try:
        ...
        # Migration 2 predates room history in some installed databases.
        connection.execute(
            """
            CREATE TABLE IF NOT EXISTS room_creations (
                id INTEGER PRIMARY KEY AUTOINCREMENT,
...
def database_summary(config: dict) -> dict[str, Any]:
    ...
    try:
        ...
        creation_count = connection.execute("SELECT COUNT(*) FROM room_creations").fetchone()[0]
    ...
    return {
        ...
        "room_creation_count": creation_count,
        "schema_version": current_schema_version,
    }


def insert_room_creation(
